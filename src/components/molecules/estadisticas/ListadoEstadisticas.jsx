...
const ListadoEstadisticas = () => {
  ...
  // const getListadoSuscripciones = () => {
  //   for (const key of Object.keys(tiposSuscripcion)) {
  //     console.log(
  //       `Nombre: ${tiposSuscripcion[key].nombre} Valor: ${tiposSuscripcion[key].valor} `
  //     );
  //   }
  // };
  // getListadoSuscripciones();
